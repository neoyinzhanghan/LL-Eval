...
wsi_names_csv_path = "/media/hdd3/neo/PCM_all_wsi_names.csv"
...
copath_df.to_csv("/media/hdd3/neo/PCM_copath_data_2024-11-23.csv", index=False)
diff_df.to_csv("/media/hdd3/neo/PCM_differential_data_2024-11-23x.csv", index=False)
